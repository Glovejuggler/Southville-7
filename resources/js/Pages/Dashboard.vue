...
<template>
    ...
    <div class="md:flex mt-12 max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
        <Link class="w-1/4" :href="route('clients.index')">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="px-6 pt-6 bg-teal-500 dark:bg-zinc-900
                    ...
                    <div class="grid place-items-end">
                        <span class="text-[64px] text-white font-extrabold">{{ clients }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <Link class="w-1/4" href="/clients?status=active">
        <div class="max-w-7xl mx-auto p-3 lg:p-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        ...
        <Link class="w-1/4" href="/clients?status=overdue">
        <div class="max-w-7xl mx-auto p-3 lg:p-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        ...
        <Link class="w-1/4" href="/clients?status=dueToday">
        <div class="max-w-7xl mx-auto p-3 lg:p-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
