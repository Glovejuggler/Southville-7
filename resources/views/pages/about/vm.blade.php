...
<div class="py-12">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 lg:flex">
        <div class="bg-white rounded-lg p-8 lg:w-9/12">
            <span class="font-bold text-xl block text-theme-900 pb-2">Vision (Bisyon)</span>
            ...
            <span class="font-bold text-xl block text-theme-900 pt-8 pb-2">Mission (Misyon)</span>
            ...
            <span class="font-bold text-xl block text-theme-900 pt-8 pb-2">Values (Pagpapahalaga)</span>
