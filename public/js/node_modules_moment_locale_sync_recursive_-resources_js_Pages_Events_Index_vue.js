...
var __default__ = {
  ...
  methods: {
    ...
    loadMoreEvents: function loadMoreEvents() {
      ...
      return axios.get(this.visisbleEvents.next_page_url).then(function (response) {
        _this.visisbleEvents = _objectSpread(_objectSpread({}, response.data), {}, {
          data: [].concat(_toConsumableArray(_this.visisbleEvents.data), _toConsumableArray(response.data.data))
        });
      });
    }
  }
